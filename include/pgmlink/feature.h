...
{
public:
    PGMLINK_EXPORT SpatialBorderAwareWeight( double cost, double margin, bool relative, FieldOfView& fov, size_t time_border)
        : cost_(cost), margin_(margin), relative_(relative), fov_(fov), time_border_(time_border)
    {
...
public:
    ...
    PGMLINK_EXPORT double operator()() const
    {
        return value;
    };
