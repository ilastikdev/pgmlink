...
public:
    ...
    void innerFunction( InnerFunctionType* f )
    {
        delete inner_;
        inner_ = f;
    };
    InnerFunctionType* innerFunction()
    {
        return inner_;
    };
    const InnerFunctionType* innerFunction() const
    {
        return inner_;
    };
    void weight( const ValueType& w )
    {
        weight_ = w;
    };
