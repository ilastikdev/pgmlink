...
public:
    ...
    PGMLINK_EXPORT virtual bool is_applicable(const FeatureMap& m) const
    {
        return m.count(feature_name_) == 1;
    };
...
public:
    ...
    PGMLINK_EXPORT virtual ComLocator* clone()
    {
        return new ComLocator(*this);
    }
...
public:
    ...
    PGMLINK_EXPORT virtual ComCorrLocator* clone()
    {
        return new ComCorrLocator(*this);
    }
    PGMLINK_EXPORT double X(const FeatureMap& m) const
    {
        return x_scale * coordinate_from(m, 0);
...
public:
    ...
    PGMLINK_EXPORT virtual IntmaxposLocator* clone()
    {
        return new IntmaxposLocator(*this);
    }
    PGMLINK_EXPORT double X(const FeatureMap& m) const
    {
        return x_scale * coordinate_from(m, 1);
    }
    PGMLINK_EXPORT double Y(const FeatureMap& m) const
    {
        return y_scale * coordinate_from(m, 2);
    }
    PGMLINK_EXPORT double Z(const FeatureMap& m) const
    {
        return z_scale * coordinate_from(m, 3);
    }
...
//                        FeatureMap fmap = FeatureMap(),
    ...
    PGMLINK_EXPORT ~Traxel()
    {
        delete locator_;
    }
    PGMLINK_EXPORT Traxel& set_locator(Locator*);
    PGMLINK_EXPORT Locator* locator()
    {
        return locator_;
    }
