...
public:
    PGMLINK_EXPORT
    ConsExplicitTracking(int max_number_objects = 3,
                 bool size_dependent_detection_prob = false,
                 double avg_obj_size = 30.0,
                 double max_neighbor_distance = 20,
                 bool with_divisions = true,
    ...
    PGMLINK_EXPORT
    ConsExplicitTracking(boost::shared_ptr<HypothesesGraph> g,
                 TraxelStore& ts,
    ...
    PGMLINK_EXPORT EventVectorVectorVector track_from_param(ConservationExplicitTracking::Parameter& param,
                                                            bool fixLabeledNodes = false);

    PGMLINK_EXPORT ConservationExplicitTracking::Parameter get_conservation_tracking_parameters(
            double forbidden_cost = 0,
            double ep_gap = 0.01,
            bool with_tracklets = true,
            double detection_weight = 10.,
...
protected:
    ...
    FieldOfView fov_;
    std::string event_vector_dump_filename_;
    std::vector<ConservationExplicitTracking::IlpSolution> ilp_solutions_;
    ...
    boost::shared_ptr<HypothesesGraph> original_hypotheses_graph_;
    boost::shared_ptr<HypothesesGraph> resolved_graph_;
    boost::shared_ptr<ConservationExplicitTracking> pgm_;

    bool with_optical_correction_;
    UncertaintyParameter uncertainty_param_;
    ConservationExplicitTracking::SolverType solver_;
