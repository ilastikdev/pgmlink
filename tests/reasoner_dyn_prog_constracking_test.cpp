#define BOOST_TEST_MODULE reasoner_dyn_prog_constracking_test
...
//    detProb[0] = 0.01; detProb[1] = 0.4; detProb[2] = 0.59;
...
//    add(ts, fs, n41);
//    n42.Id = 13; n42.Timestep = 4; com[0] = 2; com[1] = 2; com[2] = 2; divProb[0] = 0.1;
//    detProb[0] = 0.01; detProb[1] = 0.98; detProb[2] = 0.01;
...
//    ConsTrackingDynProg tracking = ConsTrackingDynProg(2, // max_number_objects
...
//    n12.features["com"] = com; n12.features["divProb"] = divProb; n12.features["count"] = count;
//    add(ts, fs, n12);
//    n21.Id = 10; n21.Timestep = 2; com[0] = 0; com[1] = 0; com[2] = 0; divProb[0] = 0.0; count[0] = 1; // Why does a divProb=0.1 yield different results for DPCT?
//    n21.features["com"] = com; n21.features["divProb"] = divProb; n21.features["count"] = count;
//    add(ts, fs, n21);
