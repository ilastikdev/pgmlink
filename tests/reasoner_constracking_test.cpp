...
BOOST_AUTO_TEST_CASE( Tracking_ConservationTracking_Merger )
{
    ...
    std::vector< std::vector<Event> > events = tracking(ts,
            ...
            1e+75, // cplex_timeout
            pgmlink::TimestepIdCoordinateMapPtr(),
            boost::python::object()
           )[0];
...
BOOST_AUTO_TEST_CASE( Tracking_ConservationTracking_Appearance )
{
    ...
    divProb[0] = 0.1;
    count[0] = 10;
    n23.features["com"] = com;
    n23.features["divProb"] = divProb;
    n23.features["count"] = count;
    add(ts, fs, n23);
    n33.Id = 9;
    n33.Timestep = 3;
    com[0] = 10;
    ...
    divProb[0] = 0.1;
    count[0] = 10;
    n33.features["com"] = com;
    n33.features["divProb"] = divProb;
    n33.features["count"] = count;
    add(ts, fs, n33);
    ...
    divProb[0] = 0.1;
    count[0] = 1;
    n35.features["com"] = com;
    n35.features["divProb"] = divProb;
    n35.features["count"] = count;
    add(ts, fs, n35);
...
BOOST_AUTO_TEST_CASE( Tracking_ConservationTracking_Merger3 )
{
    ...
    coordinates[1] = com[1];
    coordinates[2] = com[2];
    coordinates[3] = com[0] + 1;
    coordinates[4] = com[1] + 1;
    coordinates[5] = com[2] + 1;
    ...
    detProb[1] = 0.98;
    detProb[2] = 0.01;
    n43.features["com"] = com;
    n43.features["divProb"] = divProb;
    n43.features["detProb"] = detProb;
    coordinates[0] = com[0];
    coordinates[1] = com[1];
    coordinates[2] = com[2];
    coordinates[3] = com[0] + 1;
...
BOOST_AUTO_TEST_CASE( Tracking_ConservationTracking_Factorize )
{
