...
BOOST_AUTO_TEST_CASE( Tracking_ConservationTracking_Funkey_Learn_From_Labeled_Graph )
{
    ...
    divProb[0] = 0.01;
    count[0] = 1;
    n44.features["com"] = com;
    n44.features["divProb"] = divProb;
    n44.features["count"] = count;
    add(ts, fs, n44);
    ...
    divProb[0] = 0.01;
    count[0] = 1;
    n54.features["com"] = com;
    n54.features["divProb"] = divProb;
    n54.features["count"] = count;
    add(ts, fs, n54);
    ...
    divProb[0] = 0.01;
    count[0] = 1;
    n64.features["com"] = com;
    n64.features["divProb"] = divProb;
    n64.features["count"] = count;
    add(ts, fs, n64);
